...
export const normalizeProductDataProxy = functions
  .runWith({
      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          responseSchema: {
            type: Type.OBJECT,
            properties: {
              titulo_normalizado: { type: Type.STRING },
              descripcion_normalizada: { type: Type.STRING },
              categoria_sugerida: { type: Type.STRING },
              marca_sugerida: { type: Type.STRING },
            },
